...
void
CStudHealthy::Speak(void)
{
    cout << "HealthyStudent speak" << endl;
}

void
CStudDeaf::Speak(void)
{
    cout << "DeafStudent speak by hand" << endl;
}
...
void
CTeacherNew::Teach(void)
{
    cout << "New Teacher teaching by PPT" << endl;
}

void
CTeacherOld::Teach(void)
{
    cout << "Old Teacher teaching by hand" << endl;
}
